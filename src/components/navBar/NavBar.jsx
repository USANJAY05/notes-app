  ...
  return (
    <nav className='p-2 border-b dark:border-b-gray-700 bg-white dark:bg-black dark:text-white'>
      <ul className='flex justify-between'>
        <li className='flex gap-1 items-center hover:bg-gray-200 dark:hover:bg-gray-700 w-10 h-10 justify-center rounded-full'><SlArrowLeft onClick={() => navigate('/')} /></li>
        ...
        <li className='flex gap-2 items-center'>
          <div className='p-2 hover:dark:bg-gray-700 hover:bg-gray-200 rounded-full'>
            <PiNotePencilThin onClick={() => navigate('/')} className='w-6 h-6' />
          </div>
